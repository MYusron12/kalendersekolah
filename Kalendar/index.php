	...
	<div class="container">
		<div class="three columns alpha">
			<div id="top" style="display:inline;">
				<span class="logo"><a href="index.html">NUSA PUTRA</a></span><br/>
	...
	<div class="container">
		<div class="nine columns alpha">
			<div class="rslides_container">
				<ul class="rslides" id="slider2">
					<li><a href="#"><img src="Foto guru/ww.jpg" alt="" class="slidepic"></a></li>
					<li><a href="#"><img src="Foto guru/10264293_774158092596671_3404086805672689330_n.jpg" alt="" class="slidepic"></a></li>
					<li><a href="#"><img src="Foto guru/ww.jpg" alt="" class="slidepic"></a></li>
				</ul>
			</div>
		</div>
		<div class="seven columns omega">
			<div class="slidertext">
				<h1>SMA NUSA PUTRA</h1>
				<h2>Mempertahankan dan Mengembangkan : </h2>
				<p><ul>
...
<div class="container">
	...
	<div class="copyright">
		<div class="gototopmobile">
		 ...
		 Copyright &copy; 2014 SMA NEGRI NUSAPUTRA by : SUCI
	</div>
	<!-- Scripts
================================================== -->
